...
func TestGetDerivedKey(t *testing.T) {
	keys := GetDerivedKey([]byte("stronk_password"), util.DecodeHex("0f2274f6c0daf36d5822d97985be5a3d881d11e2e741bad4e038a099eecc3b6d"), 262144, 32)
	macArray := util.GenerateMac(keys, util.DecodeHex("dc55047d51f795509ffb6969db837a4481887ccfb6bfb7c259fb77b19078c2a4"))
	println()
